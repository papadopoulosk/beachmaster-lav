            ...
            <div id="collapseThree" class="panel-collapse collapse">
              <div class="panel-body">
                <div class="col-md-5 col-xs-12">    
                    <div class="form-group">
                        {{ Form::label('hasBeachBar', trans('menu.beachBar') ) }}
                        {{ Form::radio('hasBeachBar', '1') }} Yes
                        {{ Form::radio('hasBeachBar', '0') }} No
                    </div>
                    <div class="form-group">
                        {{ Form::label('hasWifi',trans('menu.wifi')) }}
                        {{ Form::radio('hasWifi', '1') }} Yes
                        {{ Form::radio('hasWifi', '0') }} No
                    </div>
                    <div class="form-group">
                        {{ Form::label('hasShade',trans('menu.naturalShade')) }}
                        {{ Form::radio('hasShade', '1') }} Yes
                        {{ Form::radio('hasShade', '0') }} No
                    </div>
                    <div class="form-group">
                        {{ Form::label('hasRoadAccess',trans('menu.roadAccess') ) }}
